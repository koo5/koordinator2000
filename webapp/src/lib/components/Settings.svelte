<script lang="ts">
    import { addNotification, theme, user } from '$lib/stores';
...
<div class="settings-container">
    ...
    <div class="settings-section">
        ...
        <div class="setting-item">
            ...
            <div class="toggle">
                <input type="checkbox" id="dark-mode" bind:checked={darkMode} on:change={toggleDarkMode} />
        ...
        <div class="setting-item">
            ...
            <input type="range" id="saturation" min="-50" max="50" bind:value={saturation} on:input={updateSaturation} />
